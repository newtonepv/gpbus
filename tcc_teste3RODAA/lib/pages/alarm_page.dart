...
class TimePickerWidget extends StatefulWidget {
  ...
  TimePickerWidget({required this.selectedTime, required this.onTimeChanged});
...
class WeekdaySelectionWidget extends StatelessWidget {
  ...
  WeekdaySelectionWidget(
      {required this.selectedWeekdays, required this.onWeekdayTapped});
...
class NameTextFieldWidget extends StatelessWidget {
  ...
  NameTextFieldWidget({required this.alarmName, required this.onNameChanged});
