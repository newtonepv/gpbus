...
namespace GPbuS
{
    public partial class FormAlterarMoto : Form
    {
        ...
        public FormAlterarMoto(string nome, string dataNasc, string cnh, string email, int numOnibus, string celular, string estado, string cidade, string endereco, string cep, string avaliacao)
        {
            InitializeComponent();
            txtNome.Text = nome;
            txtEmail.Text = email;
            txtData.Text = dataNasc;
            txtCNH.Text = cnh;
            cbxNumeroOnibus.Text = numOnibus.ToString();
        ...
        {
            Motorista motorista = new Motorista(txtNome.Text, txtData.Text, txtCNH.Text, txtEmail.Text, int.Parse(cbxNumeroOnibus.Text), null, "", txtCelular.Text, cbxEstado.Text, cbxCidade.Text, txtEndereco.Text, txtCEP.Text);
            if (motorista.atualizarMotorista())
            {
        ...
        private void FormAlterarMoto_Load(object sender, EventArgs e)
        {
